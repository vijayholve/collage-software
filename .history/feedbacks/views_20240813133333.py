...
from students.models import FeedbackQuestion, FeedbackOption,FeedbackCategory 
...
def Feedback_Category(request,category_id):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'submit_feedback.html', {'questions': questions})
