...
from .forms import FeedbackQuestionForm, FeedbackOptionForm
from .models import FeedbackQuestion, FeedbackOption
...
def add_option(request, question_id):
    ...
    return render(request, 'add_option.html', {'option_form': option_form, 'question': question})