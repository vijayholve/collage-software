...
def timetable_list(request,classid):
    classgroup=ClassGroup.objects.fe
    days_of_week = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday']
    timetables = {day: Timetable.objects.filter(time_slot__day_of_week=day).order_by('time_slot__start_time') for day in days_of_week}
