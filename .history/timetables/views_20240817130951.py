...
@register.filter
def get_slot(entries, args):
    # Ensure `args` is split into the required parameters
    start_time, end_time, day = args.split(':')
    # Your logic to filter `entries` based on `start_time`, `end_time`, and `day`
