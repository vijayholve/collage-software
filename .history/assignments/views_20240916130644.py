...
def assignment_table(request,id):
    ...
    content={'assignemnts':assignemnts,"students":students,
             "students_assignements":students}
    return render(request,"C:\Users\Vijay\python pro\attendance2\templates\assignements\assignments_table_students.html")
