...
def assignements_of_all_students(request,assignmentid):
    ...
    return render(request,"C:\Users\Vijay\python pro\attendance2\templates\assignements\assignemnt_checking.html,content)
