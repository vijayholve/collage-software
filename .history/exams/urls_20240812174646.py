...
urlpatterns = [
    ...
    path('add_question/<int:test_id>/', views.add_question_option, name='add_question'),
    path(),
    ...
    path('update-question/<str:quistion_id>/',views.update_quistion,name="update-question"),
    path('delete-quistion/<str:id>/',views.quistion_delete,name="delete-question"),
