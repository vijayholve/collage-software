...
def take_test(request, test_id):
    ...
    if request.method == 'POST':
        ...
        for question in test.questions.all():
            ...
            if selected_option_id is None:
                unanswered_questions.add(question.id)
            else:
    ...
    # Retrieve previously answered questions
    answered_questions = set(
        StudentAnswer.objects.filter(student=student, question__in=questions).values_list('question_id', flat=True)
    )
