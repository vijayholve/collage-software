...
def home_exams(request):
    ...
    u  # Use get_or_create to avoid duplicate entries
    ...
    return render(request, 'exams/take_test.html', {'test': test, 'questions': questions})pcoming_tests = upcoming_tests.order_by('test_date', 'start_time')
