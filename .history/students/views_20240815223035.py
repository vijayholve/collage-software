...
Your function container determines the type of user and renders different templates based on the user type. Below is a refined version of the container function with better structure and handling:
...
def particular_student_attendance(request, sid): 
    ...
    start_date = today.replace(day=1)  # Start from the first day of the current month
    end_date = today  # End at the current day
    ...
    # Prepare the calendar structure
