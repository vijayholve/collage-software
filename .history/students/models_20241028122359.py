...
class Student(models.Model):
    ...
    user = models.OneToOneField(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL,null=True,blank=True,related_name="student")
...
class Teacher(models.Model):
    ...
    class_teacher_of = models.OneToOneField(class, on_delete=models.SET_NULL, null=True, blank=True, related_name='class_teacher')
    classes = models.ManyToManyField(ClassGroup, related_name='teachers', blank=True)  
...
class StudentScore(models.Model):
    student = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE,related_name='score')  
    test = models.ForeignKey(Test, on_delete=models.CASCADE) 
    score = models.PositiveIntegerField(default=0) 
    is_passed=models.BooleanField(default=True,null=True,blank=True)
