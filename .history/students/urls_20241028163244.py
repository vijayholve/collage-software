...
path('attendance_export_date_form/<str:class',views.attendance_export_date_form,name="attendance_export_date_form"),
path("export_data_exel_past/<str:class_id>/",views.export_past_data_excel,name="expord-past-data"),
