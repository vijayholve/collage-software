...
urlpatterns = [
    ...
    path("",views.container,name="container"),
    path("attendance/<str:pk>/",views.student_list,name="attendance-list"),
    path("attendance-one/<str:sid>/",views.particular_student_attendance,name="attendance-one"),    path('mark/<int:student_id>/', views.mark_attendance, name='mark_attendance'),
