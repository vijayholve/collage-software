...
def import_data(request,classid):
    ...
    years=classgroup.objects.filter(name__name="BCA")
    if request.method == 'POST':
        try:
            ...
            classgroup=ClassGroup.objects.get(name__name=class_obj,year=year)   
    ...
    return render(request,"students/sclass_selecting.html",content)