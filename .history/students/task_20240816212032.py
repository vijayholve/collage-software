...
def send_absence_emails():
    ...
    for record in absentees:
        ...
        subject = record.subject.name if record.subject else 'No Subject'
        try:
            send_mail(
                'Attendance Notification',
                f'Dear {student.name},\n\nYou were marked absent for the subject "{subject}" on {today}. Please contact your teacher if this is a mistake.',
                'from@example.com',
