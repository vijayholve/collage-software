...
class Timetable(models.Model):
    ...
    def __str__(self):
        return f"{self.classgroup} - {self.subject} - {self.teacher} - {self.day_of_week}"
...
class TimetableSlot(models.Model):
    ...
    def __str__(self):
        return f"{self.timetable.classgroup} - {self.timetable.subject} - {self.start_time} to {self.end_time}"
