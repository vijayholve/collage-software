...
def particular_student_attendance(request, sid): 
    ...
    attendance_apsent_count=Attendance.objects.exclude(date__range=[start_date, end_date]).exists()
    attendance_present_count=Attendance.objects.filter(date__range=[start_date, end_date],present=True)
...
"attendance_apsent_count":attendance_apsent_count,
